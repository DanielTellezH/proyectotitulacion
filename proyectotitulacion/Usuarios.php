...
<head>
    ...
    if($v_hidGuardar == "SI"){
        if($v_hidClave == ""){
            ...
            // Update
            $sqlUP = mysqli_query($conn, "update usuarios set 
                                            tipo_usr_id = '$v_Tipo_usr', usuario = '$v_Usuario', nombre_usuario = '$v_Nom_usuario', 
                                            apellido_pat = '$v_Apellido_pat', apellido_mat = '$v_Apellido_mat', 
                                            correo = '$v_Correo', telefono = '$v_Telefono', edad = '$v_Edad', direccion_id = '$v_Direccion'
                                            where usuario_id = '$v_hidClave'");
            if($sqlUP != ""){
    ...
    if($v_hidModificar == "SI"){
        $slq = mysqli_query($conn, "select * from usuarios where usuario_id = '$v_hidClave'");
    ...
    // Eliminar
    if($v_hidEliminar == "SI"){
        $sqlD = mysqli_query($conn, "delete from usuarios where usuario_id='$v_hidClave'");
...
<body>
    <form name="form1" id="form1" method="get" action="Usuarios.php" onSubmit="return checaCampos();">        
        ...
        <section class="body">
            <div class="wrapper-container" style="margin-top: 40px;">
                <div class="placa">
                    <div class="header2">
                        <div class="nombre-sis">
                            MODIFICACIÓN DE USUARIOS (VULNERABLE)
                        </div>
                    </div>
                </div>
                ...
                <table width="100%" cellspacing="1">
                    ...
                    <tbody>
                        <?php
                        $sql = mysqli_query($conn, 'select usuario_id, tipo_usr_id, usuario, nombre_usuario, apellido_pat, apellido_mat, correo, telefono, edad, direccion_id from usuarios order by usuario_id');
